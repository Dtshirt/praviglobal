...
export const services = [
  {
    ...
    fullDescription: "Our Electronic Witness System (EWS) acts as a digital double-check, ensuring that every sample—eggs, sperm, and embryos—is correctly matched to the right patient at every critical step of the IVF process.",
    icon: "Shield",
    features: [
  ...
  },
  {
    ...
    fullDescription: "Our needle-free injection technology eliminates the fear and discomfort of traditional needles, providing a stress-free and virtually painless experience for your daily IVF medication routine.",
    icon: "Shield",
    features: [
      "Virtually painless delivery",
      "No needle anxiety",
