...
export const doctors = [
  ...
  },
  {
    ...
    specialty: "Clinical Director, Pravi Global IVF, Senior IVF Consultant",
    experience: "15+ years",
    qualification: "MBBS / MS, DNB, PGD(USD), MNAMS, MIMSA, MICMCH, Fellowship Reproductive Medicine",
    image: "/images/Dr-Aradhana-Kalra.jpg",
    bio: "<b>Dr. Aradhana Kalra</b> is a highly accomplished <b>Senior IVF Consultant and Reproductive Medicine Specialist</b>, currently practicing as Clinical Director at Pravi Global IVF Polyclinic, a unit of Pravi IVF & Fertility Centre, New Delhi. With over a decade of dedicated experience in the field of reproductive medicine, she is widely recognized for her clinical expertise, ethical practice, and consistently remarkable success rates in IVF and ART cycles.<br/> Dr. Kalra has played a pivotal role not only in delivering personalized fertility care to couples but also in training and mentoring fellows in reproductive medicine, contributing significantly to academic growth in the specialty. She holds an MD/MS in Obstetrics and Gynaecology and has pursued extensive advanced training to refine her expertise in assisted reproductive technologies.<br/>  Her academic and professional qualifications include <b>MS, DNB, PGD (USG), FICOG with a Fellowship in Reproductive Medicine</b>. She has also completed Diploma in Assisted Reproductive Technologies (Dip ART) from Kiel, Germany, and undergone advanced training in reproductive medicine at IRM, Kolkata, and Sir Ganga Ram Hospital, New Delhi, further strengthening her international and national exposure.<br/> Having her academic training from prestigious centers like KMC Manipal, Sir Gangaram hospital and AIIMS New Delhi , she reinstated the Delhi branch of Bournhall  clinics.  Previously, Dr. Kalra has served as Senior Reproductive Medicine Specialist at Milann Fertility and World Fertility, Delhi*, and as Director at Cloyd nine Faridabad and Kailash colony where she was instrumental in establishing and expanding comprehensive fertility services. <br/> An academician at heart, Dr. Kalra has published extensively in national and international journals and is an author of multiple chapters in reputed medical textbooks, reflecting her commitment to evidence-based practice and continuous learning.<br/> Her contributions to medicine have been recognized through several prestigious awards, including the Bhagyamma Purushotham Award (2003), Dr. B. C. Lahiri Award (2008), Dr. Satya Paul Award for Best Paper (2018), and the Distinguished Doctors Award (2021).<br/> Dr. Aradhana Kalra continues to be a trusted name in reproductive medicine, known for her compassionate approach, clinical excellence, and unwavering commitment to helping couples achieve their dream of parenthood.",
    specialties: [
