export const hospitalInfo = {
  ...
  phone: "+91 8009150040",
  email: "praviglobalinfo@praviivf.in",
...
export const services = [
  {
    ...
    slug: "electronic-witness-system",
    description: "Advanced safety technology to prevent sample mix-ups using RFID and digital tracking.",
    fullDescription: "To give you absolute peace of mind, we use a smart digital double-check system. RFID tracking monitors your eggs, sperm, and embryos at every single laboratory milestone, completely eliminating the risk of manual mix-ups.",
    icon: "Shield",
    features: [
      "Real-time RFID tracking",
      "Automatic digital mismatch alarms",
      "Continuous audit tracking logs",
      "Zero manual sample mix-up risk",
      "Total medical peace of mind"
    ],
    url: '/electronic-witness-system',
    image: '/images/ews-system.png'
  },
  {
    id: 11,
    name: "Needle-Free Injection",
    slug: "needle-free-ivf-injection",
    description: "Experience painless medication delivery with advanced pressure-based needle-free injectors.",
    fullDescription: "Taking daily hormonal injections can feel stressful and scary. Our clinic uses high-tech pressure injectors that deliver medicine safely through the skin without using a single needle, keeping your daily routine comfortable and pain-free.",
    icon: "Shield",
    features: [
      "Virtually pain-free delivery",
      "Eliminates daily needle anxiety",
      "Highly precise dose limits",
      "Prevents skin bruising & trauma",
      "Modern, patient-friendly care"
    ],
    url: '/needle-free-ivf-injection',
    image: '/images/needle-free-injection.png'
  },
  {
    id: 1,
    name: "IVF Treatment",
    ...
    fullDescription: "Every single body is unique, so we reject cookie-cutter IVF schedules. We design your egg stimulation, laboratory fertilization, and embryo transfer around your specific biology to maximize your chances of holding a healthy baby.",
    icon: "Heart",
    features: [
      "Tailored hormonal stimulation",
      "Advanced embryo culture systems",
      "Real-time embryo development checks",
      "Blastocyst transfer options",
      "Frozen embryo transfer protocols"
    ],
    url: '/ivf-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "When sperm has difficulty fertilizing the egg naturally, we use a highly precise technique. Our skilled embryologist selects a single, healthy, active sperm and injects it directly into the egg, boosting fertilization rates.",
    icon: "Users",
    features: [
      "Best solution for low count or motility",
      "High clinical fertilization rates",
      "Performed by certified embryologists",
      "Careful individual sperm selection",
      "Seamlessly combined with IVF cycles"
    ],
    url: '/icsi-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "A gentle and highly affordable treatment to begin your parenthood journey. We prepare and wash the partner's sperm, selecting the strongest ones, and place them directly into the uterus at the exact hour of ovulation.",
    icon: "Heart",
    features: [
      "Highly gentle & simple checkup",
      "Affordable treatment options",
      "Natural or medicated cycle plans",
      "Fast recovery with zero downtime",
      "Multi-cycle options if needed"
    ],
    url: '/iui-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "Take control of your biological clock. If you wish to focus on your career, education, or simply haven't met the right partner yet, our clinic uses rapid-freezing vitrification to freeze your eggs safely, keeping them young and healthy.",
    icon: "Shield",
    features: [
      "Advanced glass-like vitrification",
      "Highly secure long-term storage",
      "Excellent post-thaw survival rates",
      "Flexible future planning control",
      "Secure social or medical reasons"
    ],
    url: '/ivf-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "Infertility is a shared journey, and male factors play a part in nearly half of all cases. We provide confidential, expert semen analysis, hormonal checks, and advanced sperm recovery methods to help you achieve fatherhood.",
    icon: "Users",
    features: [
      "Detailed manual and digital semen checks",
      "Hormonal panel evaluations",
      "Minimally invasive TESA/PESA options",
      "Targeted lifestyle counseling plans",
      "Ethical medical management solutions"
    ],
    url: '/male-infertility-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "Our team helps diagnose and treat diverse female reproductive issues—from PCOS and ovulation changes to blocked tubes and endometriosis—using simple medicines, gentle surgeries, or assisted therapies.",
    icon: "Heart",
    features: [
      "Custom ovulation induction protocols",
      "High-definition diagnostic laparoscopy",
      "Gentle uterine hysteroscopy scans",
      "Balanced hormonal therapy cycles",
      "Expert PCOS & endometriosis control"
    ],
    url: '/female-infertility-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "We help couples navigate the surrogacy journey with complete medical coordination, legal safety, and psychological guidance, ensuring you follow ethical guidelines while building your family.",
    icon: "Heart",
    features: [
      "Strict legal documentation guidance",
      "Detailed medical surrogate screening",
      "Empathetic clinical coordination",
      "Constant emotional patient support",
      "100% transparent cost schedules"
    ],
    url: '/surrogacy-treatment-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "For couples needing donor assistance, we offer thoroughly screened and legally compliant egg and sperm donor options, prioritizing complete health profiling and medical safety.",
    icon: "Users",
    features: [
      "Strict egg donor health checks",
      "Verified sperm donor safety",
      "Comprehensive genetic screenings",
      "Legally secure donor protocols",
      "Absolute patient privacy protection"
    ],
    url: '/donor-services-in-lajpat-nagar-delhi',
  ...
  },
  {
    ...
    fullDescription: "Prevent genetic disorders and improve IVF success. We screen embryos for chromosomal errors before transfer, significantly lowering the risk of failed cycles or early-stage miscarriages.",
    icon: "Shield",
    features: [
      "Preimplantation testing (PGT-A)",
      "Targeted monogenic screens (PGT-M)",
      "Accurate parental carrier profiling",
      "Detailed chromosomal karyotyping",
      "Professional genetic advice sessions"
    ],
    url: '/genetic-testing',
...
export const doctors = [
  {
    ...
    bio: "Dr. Monica Sachdev is a renowned Senior IVF Consultant and Obstetrics & Gynecology Specialist with over 18 years of experience in managing infertility",
    specialties: [
      "IVF & ICSI",
...
export const testimonials = [
  ...
  },
  {
    ...
    location: "Noida",
    rating: 5,
    text: "The state-of-the-art facilities and experienced doctors make Pravi IVF the best choice in Delhi. They truly care about their patients and celebrate every success with you.",
    image: "/images/icon-7797704_640.png"
  }
];
