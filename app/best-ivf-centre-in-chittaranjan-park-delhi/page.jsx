...
export default function CRParkIVFPage() {
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in Chittaranjan Park delhi?",
      a: "Our clinic is widely recognized as the Best IVF Centre In Chittaranjan Park, New Delhi due to our High IVF Success Rate Delhi, senior specialists, and honest, ethical approach to fertility care."
    },
    {
      q: "What makes you the Best IVF Clinic In CR Park?",
      a: "It’s our combination of a High IVF Success Rate Delhi, compassionate care from an IVF Specialist In CR Park, and transparent Affordable IVF Treatment Delhi. We don't just treat you as a patient; we treat you as a family."
    },
    {
      q: "Do you offer IUI Treatment Delhi for CR Park residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as a simpler first step at our Fertility Centre In CR Park. It's a quick, affordable, and effective way for many couples to take their first step toward parenthood."
    },
    {
    ...
    },
    {
      ...
      a: "Women with PCOS often have very high success rates at our IVF Centre In Chittaranjan Park once their cycles are managed by the Best IVF Doctor In Chittaranjan Park. In fact, PCOS patients often produce many healthy eggs for IVF."
    },
    {
  ...
  const localSEO = [
    { location: "IVF Centre Near Kalkaji", text: "Located just minutes away from Kalkaji, our CR Park clinic offers a peaceful and private environment for your journey to parenthood." },
    { location: "Fertility Clinic In Greater Kailash", text: "Serving the elite community of Greater Kailash, we provide world-class reproductive science and personalized patient care." },
    { location: "IVF Treatment Near Nehru Place", text: "Conveniently accessible for professionals in Nehru Place, our centre offers flexible scheduling and advanced diagnostics." },
    { location: "Fertility Experts In Alaknanda", text: "Residents of Alaknanda trust our specialists for their deep expertise in complex cases and our high IVF success rates." },
    { location: "IVF Specialist Near East Of Kailash", text: "If you are looking for an IVF Specialist near East Of Kailash, our team brings over 18 years of clinical experience to help you conceive." },
    { location: "Fertility Care In Govindpuri", text: "Serving the diverse community of Govindpuri, we offer affordable, high-success fertility solutions and ethical medical advice." },
    { location: "IVF Consultation Near Okhla", text: "Starting your journey with an IVF consultation near Okhla is simple. Our CR Park clinic offers immediate support and personalized treatment maps." },
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Best IVF Centre In <span className="text-blue-300 italic">Chittaranjan Park</span>, New Delhi.
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best IVF Clinic In CR Park",
                "High IVF Success Rate Delhi",
                "Affordable IVF Treatment Delhi",
                "Expert IVF Specialist In CR Park"
              ].map((item, i) => (
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight italic">Advanced IVF Treatment In Chittaranjan Park: <br/><span className="text-blue-700">A Sanctuary for Your Family.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In Chittaranjan Park, New Delhi</strong>, you aren't just looking for a clinic. You're looking for a partner who understands the deep value of family in our community.
              </p>
              <p>
                At our CR Park facility, we’ve created a space that feels less like a clinic and more like a sanctuary. We’ve helped thousands of couples from <strong>Alaknanda, Kalkaji, and Greater Kailash</strong> find their way back to hope through personalized, honest care.
              </p>
            </div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
             ...
             <h3 className="text-2xl font-bold text-blue-900 mb-8">Why CR Park Trusts Us</h3>
             <ul className="space-y-6">
               {[
                 "Consultations with the Best IVF Doctor In Chittaranjan Park.",
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Expert IVF Treatment In Chittaranjan Park</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {treatments.map((treatment, i) => (
              <Link key={i} href={`/${treatment.slug}`} className="bg-stone-800/50 border border-stone-700 rounded-3xl p-8 hover:bg-stone-800 transition-all group block">
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
                 <p>
                    Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in CR Park, we pride ourselves on being honest about your chances while working tirelessly to improve them.
                 </p>
                 <p>
                    We’ve helped thousands of couples from <strong>Alaknanda, Kalkaji, and Greater Kailash</strong> find their path to parenthood when they thought all hope was lost.
                 </p>
           ...
           <div className="grid gap-6">
              {[
                { name: "Ananya & Sudeep", loc: "CR Park", text: "We spent years trying on our own. When we finally came here, we felt heard. The Best IVF Doctor In CR Park took the time to explain everything. Now we have our beautiful daughter." },
                { name: "Debashish", loc: "Alaknanda", text: "The honesty and scientific precision here are truly world-class. If you are looking for an IVF clinic near Alaknanda or Greater Kailash, this is the place to go." }
              ].map((story, i) => (
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95">
              <Phone className="w-5 h-5"/> Contact CR Park Clinic
            </a>
          </div>
        </div>
      </section>
