...
export default function PraviIVFLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Best IVF Centre in India for<br />
              <span className="text-white">
                Patients from Tajikistan
              </span>
            </h1>
            <p className="text-xl text-white mb-10 leading-relaxed">
              Experience the highest success rates with highly affordable IVF in India for Tajikistan patients. 
              Pravi Global IVF provides world-class fertility care, advanced technology, and complete travel support.
            </p>
      ...
      <InternationalSeoContent country="tajikistan" />
    </div>
  );
}
