...
export default function VasantKunjIVFPage() {
  const [activeFaq, setActiveFaq] = useState(null);

  const treatments = [
    { 
      title: "IVF Treatment In Vasant Kunj", 
      desc: "Our IVF Clinic In Vasant Kunj provides world-class IVF Treatment In Vasant Kunj with a High IVF Success Rate Delhi.",
      longDesc: "When natural conception feels like a distant dream, IVF offers a clear path forward. Our Vasant Kunj clinic uses state-of-the-art incubation and monitoring to ensure your embryos have the best possible environment to thrive."
    },
    { 
      title: "IUI Treatment Delhi", 
      desc: "Expert IUI Treatment Delhi at our Fertility Centre In Vasant Kunj. A simple and effective first step for Vasant Vihar families.",
    ...
    { 
      title: "Egg Freezing", 
      desc: "Preserve your future with advanced egg freezing at the best IVF Clinic In Vasant Kunj.",
    ...
    { 
      ...
      desc: "Compassionate Male Infertility Treatment Delhi in South Delhi. Our IVF Doctor In Vasant Kunj finds solutions for every family.",
    ...
    { 
      ...
      desc: "Consult our Female Infertility Specialist Delhi at the Best IVF Clinic In Vasant Kunj for personalized fertility care.",
    ...
    { 
      ...
      desc: "Specialized PCOS Fertility Treatment Delhi at our IVF Centre In Vasant Kunj to help you conceive safely.",
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in Vasant Kunj delhi?",
      a: "Our clinic is widely recognized as the Best IVF Centre In Vasant Kunj, New Delhi due to our High IVF Success Rate Delhi, senior specialists, and honest, ethical approach to fertility care."
    },
    {
      q: "What makes you the Best IVF Clinic In Vasant Kunj?",
      a: "It’s our combination of a High IVF Success Rate Delhi, compassionate care from an IVF Specialist In Vasant Kunj, and transparent Affordable IVF Treatment Delhi. We don't just treat you as a patient; we treat you as a family."
    },
    {
      q: "Do you offer IUI Treatment Delhi for Vasant Kunj residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as a simpler first step at our Fertility Centre In Vasant Kunj. It's a quick, affordable, and effective way for many couples to take their first step toward parenthood."
    },
    {
    ...
    },
    {
      ...
      a: "Women with PCOS often have very high success rates at our IVF Centre In Vasant Kunj once their cycles are managed by the Best IVF Doctor In Vasant Kunj. In fact, PCOS patients often produce many healthy eggs for IVF."
    },
    {
  ...
  const localSEO = [
    { location: "IVF Centre Near Vasant Vihar", text: "Residents of Vasant Vihar find our Vasant Kunj clinic to be a quiet, high-end alternative for their fertility needs. We are just minutes away, offering world-class technology in a private setting." },
    { location: "Fertility Clinic In Munirka", text: "Serving the community in Munirka, we provide accessible, high-success fertility solutions and honest medical advice for every couple." },
    { location: "IVF Treatment Near Chattarpur", text: "Couples from Chattarpur often choose us for our specialized approach to ICSI and male infertility. We are easily reachable and offer a sanctuary from the bustle of the city." },
    { location: "Fertility Experts In RK Puram", text: "If you are searching for Fertility Experts In RK Puram, our senior team brings over 18 years of experience in solving complex reproductive challenges with compassion." },
    { location: "IVF Specialist Near Mahipalpur", text: "Our clinic is a trusted resource for families in Mahipalpur and Aerocity seeking international standards of embryology and ethical patient care." },
    { location: "Fertility Care In Mehrauli", text: "Serving the historic area of Mehrauli, our Vasant Kunj centre provides a modern retreat for those on their path to parenthood." },
    { location: "IVF Consultation Near Aerocity", text: "Starting your journey with an IVF consultation near Aerocity is simple. Our Vasant Kunj clinic is just a stone's throw away, offering immediate support for your parenthood dreams." },
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 backdrop-blur-md border border-blue-400 rounded-full px-5 py-2 text-blue-100 font-semibold text-sm mb-8">
              ...
              <span>Best IVF Centre In Vasant Kunj, Delhi</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Where <span className="text-blue-300 italic">Hope</span> Finds a Home in Vasant Kunj.
            </h1>
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-xl leading-relaxed font-light">
              Experience the perfect blend of advanced medical science and compassionate fertility care. We are here to help you hold your dream in your arms.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best IVF Clinic In Vasant Kunj",
                "High IVF Success Rate Delhi",
                "Affordable IVF Treatment Delhi",
                "Expert IVF Specialist In Vasant Kunj"
              ].map((item, i) => (
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight italic">Advanced IVF Treatment In Vasant Kunj: <br/><span className="text-blue-700">A Sanctuary for Your Family.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In Vasant Kunj, Delhi</strong>, you aren't just looking for a hospital. You're looking for a partner who understands the emotional weight of infertility.
              </p>
              <p>
                At our Vasant Kunj facility, we’ve created a space that feels less like a clinic and more like a sanctuary. We’ve helped thousands of couples from <strong>Vasant Vihar, Chattarpur, and RK Puram</strong> find their way back to hope through personalized, honest care.
              </p>
            </div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
             ...
             <h3 className="text-2xl font-bold text-blue-900 mb-8">Why Vasant Kunj Trusts Us</h3>
             <ul className="space-y-6">
               {[
                 "Consultations with the Best IVF Doctor In Vasant Kunj.",
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Expert IVF Treatment In Vasant Kunj</h2>
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
                 <p>
                    Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in Vasant Kunj, we pride ourselves on being honest about your chances while working tirelessly to improve them.
                 </p>
                 <p>
                    We’ve helped thousands of couples from <strong>Vasant Vihar, Munirka, and RK Puram</strong> find their path to parenthood when they thought all hope was lost.
                 </p>
           ...
           <div className="grid gap-6">
              {[
                { name: "Suman & Rahul", loc: "Vasant Kunj", text: "We spent years trying on our own. When we finally came here, we felt heard. The Best IVF Doctor In Vasant Kunj took the time to explain everything. Now we have our beautiful twin boys." },
                { name: "Priya", loc: "Vasant Vihar", text: "Dealing with Low AMH was so scary. But the doctors here gave me hope. Their personalized approach to Low AMH Treatment Delhi was exactly what I needed. I'm 4 months pregnant today!" }
              ].map((story, i) => (
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95">
              <Phone className="w-5 h-5"/> Contact Vasant Kunj Clinic
            </a>
          </div>
        </div>
      </section>
