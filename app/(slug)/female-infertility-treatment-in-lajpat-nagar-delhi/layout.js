export const metadata = {
  title: "Female Infertility Treatment in Lajpat Nagar Delhi | Pravi IVF",
  description: "Struggling to conceive? Expert female infertility treatment in Lajpat Nagar, Delhi. At Pravi Global IVF, we diagnose and treat tubal issues, PCOS, and ovarian reserves.",
  robots: {
    index: true,
    follow: true,
  },
  alternates: {
    canonical: "https://praviglobalivf.com/female-infertility-treatment-in-lajpat-nagar-delhi/",
  },
  openGraph: {
    title: "Female Infertility Treatment in Lajpat Nagar Delhi | Pravi IVF",
    description: "Struggling to conceive? Expert female infertility treatment in Lajpat Nagar, Delhi. At Pravi Global IVF, we diagnose and treat tubal issues, PCOS, and ovarian reserves.",
    url: "https://praviglobalivf.com/female-infertility-treatment-in-lajpat-nagar-delhi/",
    ...
    "@graph": [
      {
        ...
        "name": "Female Infertility Treatment in Lajpat Nagar Delhi",
