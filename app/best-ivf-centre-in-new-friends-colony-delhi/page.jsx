...
import { Phone, CheckCircle, Activity, Heart, Shield, Users, MapPin, Plus, Minus, ArrowRight, Star, Award, Info, Sparkles } from 'lucide-react';
import Image from 'next/image';
import Link from 'next/link';

export default function NFCIVFPage() {
  const [activeFaq, setActiveFaq] = useState(null);

  const treatments = [
    {
      title: "IVF Treatment In New Friends Colony",
      desc: "Our IVF Clinic In NFC provides world-class IVF Treatment In New Friends Colony with a High IVF Success Rate Delhi.",
      longDesc: "When you choose our NFC centre, you are choosing a team that treats your family as their own. We use the latest in reproductive science to give you the highest chance of holding your baby."
    },
    {
      title: "IUI Treatment Delhi",
      desc: "Expert IUI Treatment Delhi at our Fertility Centre In New Friends Colony. A simple and effective first step for NFC families.",
    ...
    {
      title: "Egg Freezing",
      desc: "Preserve your future with advanced egg freezing at the best IVF Clinic In New Friends Colony.",
    ...
    },
    {
      ...
      desc: "Compassionate Male Infertility Treatment Delhi in South Delhi. Our IVF Doctor In New Friends Colony finds solutions for every family.",
    ...
    },
    {
      ...
      desc: "Consult our Female Infertility Specialist Delhi at the Best IVF Clinic In New Friends Colony for personalized fertility care.",
    ...
    },
    {
      ...
      desc: "Specialized PCOS Fertility Treatment Delhi at our IVF Centre In New Friends Colony to help you conceive safely.",
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in New Friends Colony delhi?",
      a: "Pravi global ivf is widely recognized as the Best IVF Centre In New Friends Colony, New Delhi due to our High IVF Success Rate Delhi, senior specialists, and honest, ethical approach to fertility care."
    },
    {
      q: "What makes you the Best IVF Clinic In New Friends Colony?",
      a: "It’s our combination of a High IVF Success Rate Delhi, compassionate care from an IVF Specialist In New Friends Colony, and transparent Affordable IVF Treatment Delhi. We don't just treat you as a patient; we treat you as a family."
    },
    {
      q: "Do you offer IUI Treatment Delhi for NFC residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as a simpler first step at our Fertility Centre In New Friends Colony. It's a quick, affordable, and effective way for many couples to take their first step toward parenthood."
    },
    {
    ...
    },
    {
      ...
      a: "Women with PCOS often have very high success rates at our IVF Centre In New Friends Colony once their cycles are managed by the Best IVF Doctor In New Friends Colony. In fact, PCOS patients often produce many healthy eggs for IVF."
    },
    {
  ...
  const localSEO = [
    { location: "IVF Centre Near Jangpura", text: "Residents of Jangpura and Lajpat Nagar find our NFC clinic to be a quiet, high-end alternative for their fertility needs, offering world-class technology in a private setting." },
    { location: "Fertility Clinic In Okhla", text: "Serving the professional hub of Okhla, we provide accessible, high-success fertility solutions and ethical medical advice for every family." },
    { location: "IVF Treatment Near Sarita Vihar", text: "Couples from Sarita Vihar trust our specialists for their deep expertise in complex cases and our consistently high IVF success rates." },
    { location: "Fertility Experts In Defence Colony", text: "If you are searching for Fertility Experts in Defence Colony, our senior team brings over 18 years of experience in solving complex reproductive challenges with compassion." },
    { location: "IVF Specialist Near Lajpat Nagar", text: "Our location is ideal for residents of Lajpat Nagar and Ashram seeking a modern fertility sanctuary with international lab standards." },
    { location: "Fertility Care In Maharani Bagh", text: "Serving the elite neighborhood of Maharani Bagh, our NFC centre provides a level of discretion and medical excellence that is truly world-class." },
    { location: "IVF Consultation Near Nehru Place", text: "Starting your journey with an IVF consultation near Nehru Place is simple. Our NFC clinic offers immediate support and personalized treatment maps." },
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 backdrop-blur-md border border-blue-400 rounded-full px-5 py-2 text-blue-100 font-semibold text-sm mb-8">
              ...
              <span>Best IVF Centre In New Friends Colony, New Delhi</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Where <span className="text-blue-300 italic">Hope</span> Meets Elite Science in NFC.
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best IVF Clinic In New Friends Colony",
                "High IVF Success Rate Delhi",
                "Affordable IVF Treatment Delhi",
                "Expert IVF Specialist In NFC"
              ].map((item, i) => (
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight italic">Advanced IVF Treatment In New Friends Colony: <br /><span className="text-blue-700">A Sanctuary for Your Family.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In New Friends Colony, New Delhi</strong>, you aren't just looking for a clinic. You're looking for a partner who understands the high standards of our community.
              </p>
              <p>
                At our NFC facility, we’ve created a space that feels less like a clinic and more like a sanctuary. We’ve helped thousands of couples from <strong>Maharani Bagh, Sarita Vihar, and Jangpura</strong> find their way back to hope through personalized, honest care.
              </p>
            </div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
            ...
            <h3 className="text-2xl font-bold text-blue-900 mb-8">Why NFC Trusts Us</h3>
            <ul className="space-y-6">
              {[
                "Consultations with the Best IVF Doctor In New Friends Colony.",
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Expert IVF Treatment In New Friends Colony</h2>
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in NFC, we pride ourselves on being honest about your chances while working tirelessly to improve them.
              </p>
              <p>
                We’ve helped thousands of couples from <strong>Maharani Bagh, Sarita Vihar, and Jangpura</strong> find their path to parenthood when they thought all hope was lost.
              </p>
          ...
          <div className="grid gap-6">
            {[
              { name: "Anjali & Vikram", loc: "NFC", text: "We spent years trying on our own. When we finally came here, we felt heard. The Best IVF Doctor In New Friends Colony took the time to explain everything. Now we have our beautiful twin boys." },
              { name: "Priya", loc: "Maharani Bagh", text: "The honesty and scientific precision here are truly world-class. If you are looking for an IVF clinic near Maharani Bagh or Sarita Vihar, this is the place to be." }
            ].map((story, i) => (
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95">
              <Phone className="w-5 h-5" /> Contact NFC Clinic
            </a>
          </div>
        </div>
      </section>
