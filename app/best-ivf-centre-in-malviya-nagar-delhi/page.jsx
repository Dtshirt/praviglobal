...
export default function MalviyaNagarIVFPage() {
  const [activeFaq, setActiveFaq] = useState(null);

  const treatments = [
    { 
      title: "IVF Treatment In Malviya Nagar", 
      desc: "Our IVF Clinic In Malviya Nagar provides the most advanced IVF Treatment In Malviya Nagar with a High IVF Success Rate Delhi.",
      longDesc: "When natural conception feels like a distant dream, IVF offers a clear path forward. Our Malviya Nagar clinic uses state-of-the-art incubation and monitoring to ensure your embryos have the best possible environment to thrive."
    },
    { 
      title: "IUI Treatment Delhi", 
      desc: "Expert IUI Treatment Delhi at our Fertility Centre In Malviya Nagar. A simple and effective first step for Saket families.",
    ...
    { 
      title: "Egg Freezing", 
      desc: "Preserve your future with advanced egg freezing at the best IVF Clinic In Malviya Nagar.",
    ...
    { 
      ...
      desc: "Compassionate Male Infertility Treatment Delhi in South Delhi. Our IVF Doctor In Malviya Nagar finds solutions for every family.",
    ...
    { 
      ...
      desc: "Consult our Female Infertility Specialist Delhi at the Best IVF Clinic In Malviya Nagar for personalized fertility care.",
    ...
    { 
      ...
      desc: "Specialized PCOS Fertility Treatment Delhi at our IVF Centre In Malviya Nagar to help you conceive safely.",
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in Malviya Nagar delhi?",
      a: "Our clinic is widely recognized as the Best IVF Centre In Malviya Nagar, New Delhi due to our High IVF Success Rate Delhi, senior specialists, and honest, ethical approach to fertility care."
    },
    {
      q: "What makes you the Best IVF Clinic In Malviya Nagar?",
      a: "It’s our combination of a High IVF Success Rate Delhi, compassionate care from an IVF Specialist In Malviya Nagar, and transparent Affordable IVF Treatment Delhi. We don't just treat you as a patient; we treat you as a family."
    },
    {
      q: "Do you offer IUI Treatment Delhi for Malviya Nagar residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as a simpler first step at our Fertility Centre In Malviya Nagar. It's a quick, affordable, and effective way for many couples to take their first step toward parenthood."
    },
    {
    ...
    },
    {
      ...
      a: "Women with PCOS often have very high success rates at our IVF Centre In Malviya Nagar once their cycles are managed by the Best IVF Doctor In Malviya Nagar. In fact, PCOS patients often produce many healthy eggs for IVF."
    },
    {
  ...
  const localSEO = [
    { location: "IVF Centre In Saket", text: "Couples looking for an IVF Centre In Saket often find our Malviya Nagar clinic to be the perfect blend of proximity and specialized care. Just a few minutes away, we offer a level of privacy and advanced technology that makes the short commute worth it." },
    { location: "Fertility Clinic Near Hauz Khas", text: "Serving the vibrant community of Hauz Khas, our fertility centre provides a calm retreat from the bustle. We specialize in high-success IVF and have helped many families from the Hauz Khas area achieve their dreams." },
    { location: "IVF Treatment Near Panchsheel Park", text: "For residents of Panchsheel Park, accessibility to world-class healthcare is a priority. Our Malviya Nagar facility is equipped with a Class 100 IVF lab, ensuring that you don't have to travel far for international standards of fertility care." },
    { location: "Fertility Experts In Green Park", text: "If you are searching for Fertility Experts In Green Park, our senior doctors bring nearly two decades of experience to your doorstep. We offer comprehensive diagnostics and personalized treatment plans just a short drive away." },
    { location: "IVF Specialist Near Greater Kailash", text: "Residents of Greater Kailash trust our IVF specialists for their deep expertise in complex cases. Whether it's recurrent miscarriage or low ovarian reserve, we provide the answers you need." },
    { location: "Fertility Care In Pushp Vihar", text: "Located conveniently for Pushp Vihar families, our Malviya Nagar centre offers a full spectrum of fertility solutions, from IUI to advanced ICSI." },
    { location: "IVF Consultation Near Chirag Delhi", text: "Starting your journey with an IVF consultation near Chirag Delhi is easy. Our Malviya Nagar clinic is just a stone's throw away, offering immediate support for your parenthood dreams." },
    ...
    { location: "IVF Support Near Mehrauli", text: "Families in Mehrauli looking for ethical and successful fertility treatments can find expert care at our Malviya Nagar centre, conveniently located for quick access." },
    { location: "Fertility Services Near IIT Delhi Area", text: "Our clinic serves the intellectual and residential hub around IIT Delhi, providing advanced IVF and IUI solutions with high clinical standards." },
    { location: "Best IVF Near Khirki Extension", text: "Khirki Extension residents now have access to premium fertility care just around the corner. We offer specialized treatments for PCOS, low AMH, and male infertility." }
  ];
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 backdrop-blur-md border border-blue-400 rounded-full px-5 py-2 text-blue-100 font-semibold text-sm mb-8">
              ...
              <span>Best IVF Centre In Malviya Nagar, New Delhi</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Your Path to <span className="text-blue-300 italic">Parenthood</span> Starts Here in Malviya Nagar.
            </h1>
            <p className="text-xl text-blue-100 mb-10 max-w-xl leading-relaxed font-light">
              We know the wait has been long. At our Malviya Nagar clinic, we pair advanced fertility science with a heart that truly understands your journey.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best Fertility Doctor In Malviya Nagar",
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link href="#appointment" className="bg-blue-500 hover:bg-blue-600 text-white px-10 py-5 rounded-full font-bold text-lg text-center transition-all shadow-2xl active:scale-95">
                Book Malviya Nagar Consultation
              </Link>
          ...
          <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl relative border border-stone-100" id="appointment">
            ...
            <form className="space-y-6">
              ...
              <button type="button" className="w-full bg-blue-800 hover:bg-blue-900 text-white font-bold py-5 rounded-2xl transition-all shadow-lg active:scale-95">
                Request Malviya Nagar Callback
              </button>
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight">Advanced IVF Treatment In Malviya Nagar: <br/><span className="text-blue-700">A Sanctuary for Your Family.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In Malviya Nagar, New Delhi</strong>, you aren't just looking for a hospital. You're looking for a partner who understands the emotional weight of infertility.
              </p>
              <p>
                At our Malviya Nagar facility, we’ve created a space that feels less like a clinic and more like a sanctuary. We’ve helped thousands of couples from <strong>Saket, Hauz Khas, and Greater Kailash</strong> find their way back to hope through personalized, honest care.
              </p>
            </div>
            <div className="mt-12 grid grid-cols-2 gap-8 border-t border-stone-100 pt-12">
               <div>
                  ...
                  <div className="text-xs uppercase tracking-widest text-stone-400 mt-2">Years of Expertise</div>
               </div>
               <div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
             ...
             <h3 className="text-2xl font-bold text-blue-900 mb-8">Why Malviya Nagar Trusts Us</h3>
             <ul className="space-y-6">
               {[
                 "Consultations with the Best IVF Doctor In Malviya Nagar.",
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Expert IVF Treatment In Malviya Nagar</h2>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-stone-500 font-light">We are proud to serve families from every corner of our local community.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-blue-100 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-blue-700">Meet Your Care Team</span>
            </div>
            <h2 className="text-4xl font-bold text-stone-900 mb-4">The Hands That Help You</h2>
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
                 <p>
                    Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in Malviya Nagar, we pride ourselves on being honest about your chances while working tirelessly to improve them.
                 </p>
                 <p>
                    We’ve helped thousands of couples from <strong>Chirag Delhi, Sheikh Sarai, and Pushp Vihar</strong> find their path to parenthood when they thought all hope was lost.
                 </p>
                 <p className="text-sm italic text-stone-400">
                    *Success rates vary depending on age, medical history, and specific fertility conditions.
                 </p>
              </div>
           </div>
           <div className="grid gap-6">
              {[
                { name: "Suman & Rahul", loc: "Malviya Nagar", text: "We spent years trying on our own. When we finally came here, we felt heard. The IVF Specialist In Malviya Nagar took the time to explain everything. Now we have our beautiful twin boys." },
                { name: "Priya", loc: "Saket", text: "Dealing with Low AMH was so scary. But the doctors here gave me hope. Their personalized approach to Low AMH Treatment Delhi was exactly what I needed. I'm 4 months pregnant today!" }
              ].map((story, i) => (
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95">
              <Phone className="w-5 h-5"/> Call Our Malviya Nagar Clinic
            </a>
          </div>
        </div>
      </section>
