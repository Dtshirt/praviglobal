...
export default function KalkajiIVFPage() {
  const [activeFaq, setActiveFaq] = useState(null);

  const treatments = [
    { 
      title: "IVF Treatment In Kalkaji", 
      desc: "Our IVF Clinic In Kalkaji provides advanced IVF Treatment In Kalkaji with a High IVF Success Rate Delhi.",
      longDesc: "When you choose our Kalkaji centre, you are choosing a team that treats your family as their own. We use the latest in reproductive science to give you the highest chance of holding your baby."
    },
    { 
      title: "IUI Treatment Delhi", 
      desc: "Expert IUI Treatment Delhi at our Fertility Centre In Kalkaji. A simple and effective first step for CR Park families.",
      longDesc: "IUI is often the most comfortable first step for many couples. We optimize your natural cycle and time the procedure perfectly to enhance your chances of a healthy pregnancy."
    },
    { 
      title: "ICSI Treatment Delhi", 
      desc: "High-precision ICSI Treatment Delhi for male factor infertility at our leading IVF Hospital In South Delhi.",
      longDesc: "ICSI allows us to overcome even the most severe male factor challenges. By selecting a single, healthy sperm for each egg, we maximize the potential for successful fertilization."
    },
    { 
      title: "Egg Freezing", 
      desc: "Preserve your future with advanced egg freezing at the best IVF Clinic In Kalkaji.",
      longDesc: "Don't let time dictate your family planning. Our vitrification technology allows you to freeze your eggs at their peak health, securing your options for the future."
    },
    { 
      title: "Male Infertility Treatment Delhi", 
      desc: "Compassionate Male Infertility Treatment Delhi in South Delhi. Our IVF Doctor In Kalkaji finds solutions for every family.",
      longDesc: "Infertility is a shared journey. We provide discreet, professional diagnostics and advanced treatments to ensure both partners are supported every step of the way."
    },
    { 
      title: "Female Infertility Specialist Delhi", 
      desc: "Consult our senior Female Infertility Specialist Delhi at the Best IVF Clinic In Kalkaji for personalized care.",
      longDesc: "From hormonal imbalances to structural issues, we perform deep diagnostics to find the root cause of your struggles, creating a targeted path to pregnancy."
    },
    { 
      title: "PCOS Fertility Treatment Delhi", 
      desc: "Specialized PCOS Fertility Treatment Delhi at our IVF Centre In Kalkaji to help you conceive safely.",
      longDesc: "PCOS is a common but manageable challenge. Our specialists use metabolic balancing and ovulation induction to help your body produce healthy eggs for successful conception."
    },
    { 
      ...
      longDesc: "A low ovarian reserve doesn't mean your journey is over. We use specialized, gentle stimulation protocols designed to make the absolute most of every egg your body produces."
    },
  ];
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in Kalkaji delhi?",
      a: "Our clinic is widely recognized as the Best IVF Centre In Kalkaji, New Delhi due to our High IVF Success Rate Delhi, senior specialists, and honest, ethical approach to fertility care."
    },
    {
      q: "What makes you the Best IVF Clinic In Kalkaji?",
      a: "It’s our combination of a High IVF Success Rate Delhi, compassionate care from an IVF Specialist In Kalkaji, and transparent Affordable IVF Treatment Delhi. We don't just treat you as a patient; we treat you as a family."
    },
    {
      q: "Do you offer IUI Treatment Delhi for Kalkaji residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as a simpler first step at our Fertility Centre In Kalkaji. It's a quick, affordable, and effective way for many couples to take their first step toward parenthood."
    },
    {
    ...
    },
    {
      ...
      a: "Women with PCOS often have very high success rates at our IVF Centre In Kalkaji once their cycles are managed by the Best IVF Doctor In Kalkaji. In fact, PCOS patients often produce many healthy eggs for IVF."
    },
    {
  ...
  const localSEO = [
    { location: "IVF Centre Near Nehru Place", text: "Located just a stone's throw from Nehru Place, our Kalkaji clinic is the perfect choice for busy professionals. We offer high-success fertility care in a calm, convenient environment." },
    { location: "Fertility Clinic In Greater Kailash", text: "Residents of Greater Kailash trust our experts for their deep knowledge in handling complex fertility cases. We provide a boutique, personalized experience for every couple." },
    { location: "IVF Treatment Near CR Park", text: "Serving the close-knit community of CR Park, we offer a trusted sanctuary for those on their path to parenthood. We combine ethical care with world-class embryology." },
    { location: "Fertility Experts In East Of Kailash", text: "Our senior specialists are the leading fertility experts for the East Of Kailash area, bringing over 18 years of experience to every consultation." },
    { location: "IVF Specialist Near Lajpat Nagar", text: "Conveniently accessible for families in Lajpat Nagar, our Kalkaji centre provides advanced IVF and IUI solutions with absolute transparency." },
    { location: "Fertility Care In Govindpuri", text: "Located right in the heart of the community, we offer accessible and affordable fertility care for Govindpuri residents seeking honest medical advice." },
    { location: "IVF Consultation Near Okhla", text: "Starting your journey is simple with a professional IVF consultation near Okhla. We provide clear answers and personalized treatment maps for your success." },
    { location: "Fertility Clinic In South Delhi", text: "As the premier fertility clinic in South Delhi, we pride ourselves on being more than just a hospital. We are a home for your future family." }
  ];
  ...
  return (
    <div className="bg-stone-50 min-h-screen text-stone-800 font-sans">
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 backdrop-blur-md border border-blue-400 rounded-full px-5 py-2 text-blue-100 font-semibold text-sm mb-8">
              ...
              <span>Best IVF Centre In Kalkaji, New Delhi</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Your Journey to <span className="text-blue-300 italic">Parenthood</span> Starts in Kalkaji.
            </h1>
            <p className="text-xl text-blue-100 mb-10 max-w-xl leading-relaxed font-light">
              We know the wait has been long. At our Kalkaji centre, we pair advanced fertility science with a heart that truly understands your journey.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best Fertility Doctor In Kalkaji",
                "High IVF Success Rate Delhi",
                "Affordable IVF Treatment Delhi",
                "Expert IVF Specialist In Kalkaji"
              ].map((item, i) => (
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight">Advanced IVF Treatment In Kalkaji: <br/><span className="text-blue-700">A Beacon of Hope in South Delhi.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In Kalkaji, New Delhi</strong>, you aren't just looking for medical technology. You're looking for a sanctuary where your dreams of parenthood are respected and nurtured.
              </p>
              <p>
                At our Kalkaji facility, we’ve created a space that combines international clinical standards with a deeply personalized touch. We’ve helped families from <strong>Nehru Place, CR Park, and Greater Kailash</strong> overcome infertility with honesty and compassion.
              </p>
            </div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
             <div className="absolute top-0 right-0 p-8">
                <Heart className="w-12 h-12 text-blue-800 opacity-20" />
             </div>
             <h3 className="text-2xl font-bold text-blue-900 mb-8 italic">Why Kalkaji Families Trust Us</h3>
             <ul className="space-y-6">
               {[
                 "Expert guidance from the Best IVF Doctor In Kalkaji.",
                 "High IVF Success Rate Delhi even in difficult cases.",
                 "Transparent and Affordable IVF Treatment Delhi packages.",
                 "Specialized PCOS Fertility Treatment Delhi solutions.",
                 "Comprehensive Male Infertility Treatment Delhi in South Delhi."
               ].map((item, i) => (
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Expert IVF Treatment In Kalkaji</h2>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-stone-900 mb-4">Trusted Across South Delhi</h2>
            <p className="text-stone-500 font-light">Serving our local Kalkaji community with heart and science.</p>
          </div>
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
                 <p>
                    Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in Kalkaji, we pride ourselves on being honest about your chances while working tirelessly to improve them.
                 </p>
                 <p>
                    We’ve helped thousands of families from <strong>Nehru Place, Okhla, and Govindpuri</strong> find their path to parenthood when they thought all hope was lost.
                 </p>
           ...
           <div className="grid gap-6">
              {[
                { name: "Suman & Rahul", loc: "Kalkaji", text: "We spent years trying on our own. When we finally came here, we felt heard. The Best IVF Doctor In Kalkaji took the time to explain everything. Now we have our beautiful twin boys." },
                { name: "Priya", loc: "CR Park", text: "Dealing with Low AMH was so scary. But the doctors here gave me hope. Their personalized approach to Low AMH Treatment Delhi was exactly what I needed. I'm 4 months pregnant today!" }
              ].map((story, i) => (
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95">
              <Phone className="w-5 h-5"/> Contact Our Kalkaji Clinic
            </a>
          </div>
        </div>
      </section>
