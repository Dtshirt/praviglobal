...
export default function PanchsheelParkIVFPage() {
  const [activeFaq, setActiveFaq] = useState(null);

  const treatments = [
    { 
      title: "IVF Treatment In Panchsheel Park", 
      desc: "Our IVF Clinic In Panchsheel Park provides world-class IVF Treatment In Panchsheel Park with a High IVF Success Rate Delhi.",
      longDesc: "Panchsheel Park families deserve a level of medical excellence that matches their high standards. We provide a boutique fertility experience where state-of-the-art science meets a deeply compassionate patient-first philosophy."
    },
    { 
      title: "IUI Treatment Delhi", 
      desc: "Expert IUI Treatment Delhi at our Fertility Centre In Panchsheel Park. A simple and effective first step for families in South Delhi.",
      longDesc: "Intrauterine Insemination (IUI) is a gentle introduction to fertility assistance. We focus on enhancing the natural cycle, using precision monitoring and sperm optimization to give you the best possible chance at a natural conception."
    },
    { 
      ...
      longDesc: "When sperm quality or count is a challenge, ICSI offers a breakthrough solution. By selecting the healthiest single sperm for direct injection into the egg, we overcome traditional barriers to fertilization with scientific precision."
    },
    { 
      title: "Egg Freezing", 
      desc: "Preserve your future with advanced egg freezing at the best IVF Clinic In Panchsheel Park.",
      longDesc: "Your biological clock shouldn't dictate your life goals. Our advanced vitrification technology allows you to freeze your fertility at its peak, providing security and peace of mind for whenever you are ready to start your family."
    },
    { 
      title: "Male Infertility Treatment Delhi", 
      desc: "Compassionate Male Infertility Treatment Delhi in South Delhi. Our IVF Doctor In Panchsheel Park finds solutions for every family.",
      longDesc: "Fertility is never just a 'female issue.' We provide a discreet, professional environment for men to receive advanced diagnostics and surgical retrieval options, ensuring a holistic approach to the couple's fertility journey."
    },
    { 
      title: "Female Infertility Specialist Delhi", 
      desc: "Consult our Female Infertility Specialist Delhi at the Best IVF Clinic In Panchsheel Park for personalized fertility care.",
      longDesc: "From tubal factors to low ovarian reserve, our specialists dig deep into the medical 'why.' We don't just treat symptoms; we create targeted solutions based on 18+ years of reproductive clinical experience."
    },
    { 
      title: "PCOS Fertility Treatment Delhi", 
      desc: "Specialized PCOS Fertility Treatment Delhi at our IVF Centre In Panchsheel Park to help you conceive safely.",
      longDesc: "PCOS requires a delicate balance of hormonal management and metabolic support. Our customized protocols help regulate your cycles and ensure the release of healthy, mature eggs for successful conception."
    },
    { 
      ...
      longDesc: "A low egg count is a challenge, not a dead end. We use specialized, gentle stimulation techniques designed to maximize the quality of every available egg, ensuring we utilize every biological advantage you have."
    },
  ];
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in Panchsheel Park delhi?",
      a: "Pravi Global IVF is recognized as the Best IVF Centre In Panchsheel Park, New Delhi, due to our consistently High IVF Success Rate Delhi, our elite medical team, and our commitment to honest, transparent fertility care tailored for South Delhi families."
    },
    {
      q: "What makes you the Best IVF Clinic In Panchsheel Park?",
      a: "It is the combination of our world-class embryology lab, the 18+ years of experience of our senior specialists, and our patient-first approach. We treat you as a human being with a story, not just a clinical case number."
    },
    {
      q: "Do you offer IUI Treatment Delhi for Panchsheel residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as an effective first step at our Fertility Centre In Panchsheel Park. It is a minimally invasive and affordable way for many couples to begin their journey to parenthood."
    },
    {
      q: "Is IVF treatment in South Delhi expensive?",
      a: "We believe in Affordable IVF Treatment Delhi. We provide a full, transparent breakdown of all costs upfront. We also offer EMI options to ensure that financial concerns do not prevent you from accessing the best medical care."
    },
    {
      q: "What is your success rate for PCOS Fertility Treatment Delhi?",
      a: "Women with PCOS often have very high success rates at our IVF Centre In Panchsheel Park. Once their hormonal cycles are managed by the Best IVF Doctor In Panchsheel Park, they often produce a high volume of quality eggs for IVF."
    },
    {
        q: "How long does a typical IVF cycle take?",
        a: "A standard IVF cycle from stimulation to embryo transfer usually takes about 3 to 4 weeks. Most of our Panchsheel Park patients find the short morning visits for monitoring to be very convenient and non-disruptive."
    },
    {
        q: "What is Low AMH and can it be treated?",
        a: "Low AMH indicates a lower egg reserve. At our Fertility Clinic In South Delhi, we use specific 'gentle' stimulation protocols to improve egg quality and maximize the chances of a successful pregnancy even with a lower count."
    },
    {
        q: "Is Male Infertility common, and do you treat it?",
        a: "Yes, male factors contribute to nearly 40% of fertility cases. We provide specialized Male Infertility Treatment Delhi, including advanced semen analysis and ICSI, at our IVF Hospital In South Delhi."
    },
    {
        q: "Can I freeze my eggs in Panchsheel Park?",
        a: "Absolutely. Our clinic provides advanced egg freezing services, allowing women to preserve their peak fertility for future use using the latest vitrification technology."
    },
    {
        q: "Do I need bed rest after the IVF procedure?",
        a: "Modern clinical evidence shows that strict bed rest is not necessary. We encourage our patients to return to their normal (light) daily activities almost immediately, as blood flow is actually beneficial for implantation."
    }
  ];

  const localSEO = [
    { location: "IVF Centre Near Hauz Khas", text: "Just minutes away from the artistic and historic hub of Hauz Khas, our Panchsheel Park clinic offers an elite sanctuary for couples seeking a perfect blend of science and soul." },
    { location: "Fertility Clinic In Malviya Nagar", text: "Residents of Malviya Nagar trust our senior specialists for their honest advice and high success rates, providing accessible world-class care right in their neighborhood." },
    { location: "IVF Treatment Near Saket", text: "For families in Saket, we provide a sophisticated alternative for fertility care, combining the latest medical technology with a level of privacy that is truly world-class." },
    { location: "Fertility Experts In Greater Kailash", text: "If you are searching for Fertility Experts In Greater Kailash, our senior team brings 18+ years of expertise in solving complex reproductive challenges with clinical precision." },
    { location: "IVF Specialist Near Green Park", text: "Conveniently accessible from Green Park, our clinic is the first choice for professionals seeking results-oriented fertility treatments like ICSI and Egg Freezing." },
    { location: "Fertility Care In Chirag Delhi", text: "Serving the local community of Chirag Delhi, we provide compassionate and ethical medical guidance to help you navigate the complexities of infertility with confidence." },
    { location: "IVF Consultation Near IIT Delhi", text: "Our clinic is a preferred destination for the academic and professional community near IIT Delhi, offering evidence-based fertility solutions and personalized treatment maps." },
    { location: "Fertility Clinic In South Delhi", text: "As a leading fertility clinic in South Delhi, we serve as a beacon of hope for thousands. From Panchsheel Enclave to Nehru Place, we are your partners in building a future." }
  ];
    ...
    <div className="bg-stone-50 min-h-screen text-stone-800 font-sans">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Pravi Global IVF Panchsheel Park",
            "description": "Best IVF Centre In Panchsheel Park, New Delhi offering advanced fertility treatments like IUI, ICSI, and Egg Freezing.",
            "url": "https://praviivf.in/best-ivf-centre-in-panchsheel-park-delhi",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 backdrop-blur-md border border-blue-400 rounded-full px-5 py-2 text-blue-100 font-semibold text-sm mb-8">
              ...
              <span>Best IVF Centre In Panchsheel Park, New Delhi</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Where <span className="text-blue-300 italic">Hope</span> Becomes Reality in Panchsheel.
            </h1>
            <p className="text-xl text-blue-100 mb-10 max-w-xl leading-relaxed font-light">
              Experience the perfect harmony of advanced reproductive science and compassionate care. At our Panchsheel Park clinic, we don't just treat infertility; we build families.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best IVF Clinic In Panchsheel Park",
                "High IVF Success Rate Delhi",
                "Affordable IVF Treatment Delhi",
                "Expert IVF Specialist In Panchsheel"
              ].map((item, i) => (
          ...
          <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl relative border border-stone-100" id="appointment">
            ...
            <p className="text-stone-500 mb-8 leading-relaxed">Let's talk about how we can help you build your future. No pressure, just a caring conversation.</p>
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight italic">Elite IVF Treatment In Panchsheel Park: <br/><span className="text-blue-700">The Sanctuary of Hope.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In Panchsheel Park, New Delhi</strong>, you aren't just looking for a clinic. You're looking for a partner who understands the high expectations of our local community.
              </p>
              <p>
                At our Panchsheel Park facility, we’ve created a space that feels less like a clinic and more like a sanctuary. We’ve helped thousands of couples from <strong>Hauz Khas, Malviya Nagar, and Saket</strong> find their way back to hope through personalized, results-oriented care.
              </p>
              <p>
                  Led by an <strong>IVF Specialist In Panchsheel Park</strong> with over 18 years of clinical experience, we pride ourselves on transparency, medical ethics, and achieving success even in the most complex reproductive cases.
              </p>
            </div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
             ...
             <h3 className="text-2xl font-bold text-blue-900 mb-8">Why Panchsheel Trusts Us</h3>
             <ul className="space-y-6">
               {[
                 "Consultations with the Best IVF Doctor In Panchsheel Park.",
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 italic">Advanced IVF Treatment In Panchsheel Park</h2>
      ...
      <section className="py-24 px-4 bg-white border-y border-stone-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-stone-500 font-light">Serving our local community with heart, science, and absolute privacy.</p>
          </div>
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
                 <p>
                    Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in Panchsheel Park, we pride ourselves on being honest about your chances while working tirelessly to improve them.
                 </p>
                 <p>
                    We’ve helped thousands of couples from <strong>Saket, GK, and Hauz Khas</strong> find their path to parenthood when they thought all hope was lost.
                 </p>
                 <p className="text-sm italic text-stone-400 border-l-2 border-stone-200 pl-4 py-2">
           ...
           <div className="grid gap-6">
              {[
                { name: "Anjali & Vikram", loc: "Panchsheel Park", text: "We spent years trying on our own. When we finally came here, we felt heard. The Best IVF Doctor In Panchsheel Park took the time to explain everything. Now we have our beautiful twin boys." },
                { name: "Priya", loc: "Hauz Khas", text: "The honesty and scientific precision here are truly world-class. If you are looking for an IVF clinic near Hauz Khas or Malviya Nagar, this is the place to be." }
              ].map((story, i) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://www.youtube.com/watch?v=2N0bx-OFLYQ" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-6 py-3 bg-[#FF0000] text-white rounded-full font-bold transition-transform hover:scale-105">
                  <Youtube className="w-5 h-5"/> Success Stories
                </a>
              </div>
            </div>
      ...
      <section className="bg-blue-900 text-white py-24 px-4 text-center relative overflow-hidden">
        <div className="max-w-3xl mx-auto relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 italic text-blue-100">Ready to Start Your Journey?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95 shadow-xl">
              <Phone className="w-5 h-5"/> Contact Panchsheel Clinic
            </a>
          </div>
        </div>
      </section>
      ...
      <a href="https://wa.me/919999999999" target="_blank" rel="noreferrer" className="fixed bottom-10 right-10 bg-blue-500 text-white p-5 rounded-full shadow-2xl hover:bg-blue-600 transition-all z-50 flex items-center justify-center hover:scale-110 active:scale-90 shadow-lg">
