...
export default function OkhlaIVFPage() {
  const [activeFaq, setActiveFaq] = useState(null);

  const treatments = [
    { 
      title: "IVF Treatment In Okhla", 
      desc: "Our IVF Clinic In Okhla provides world-class IVF Treatment In Okhla with a High IVF Success Rate Delhi.",
      longDesc: "Okhla families deserve a level of medical excellence that matches their high standards. We provide a boutique fertility experience where state-of-the-art science meets a deeply compassionate patient-first philosophy."
    },
    { 
      title: "IUI Treatment Delhi", 
      desc: "Expert IUI Treatment Delhi at our Fertility Centre In Okhla. A simple and effective first step for families in South Delhi.",
    ...
    { 
      title: "Egg Freezing", 
      desc: "Preserve your future with advanced egg freezing at the best IVF Clinic In Okhla.",
    ...
    { 
      ...
      desc: "Compassionate Male Infertility Treatment Delhi in South Delhi. Our IVF Doctor In Okhla finds solutions for every family.",
    ...
    { 
      ...
      desc: "Consult our Female Infertility Specialist Delhi at the Best IVF Clinic In Okhla for personalized fertility care.",
    ...
    { 
      ...
      desc: "Specialized PCOS Fertility Treatment Delhi at our IVF Centre In Okhla to help you conceive safely.",
  ...
  const faqs = [
    {
      q: "Which is the best ivf center in Okhla delhi?",
      a: "Pravi Global IVF is recognized as the Best IVF Centre In Okhla, New Delhi, due to our consistently High IVF Success Rate Delhi, our elite medical team, and our commitment to honest, transparent fertility care tailored for the Okhla community."
    },
    {
      q: "What makes you the Best IVF Clinic In Okhla?",
    ...
    {
      q: "Do you offer IUI Treatment Delhi for Okhla residents?",
      a: "Yes, we often recommend IUI Treatment Delhi as an effective first step at our Fertility Centre In Okhla. It is a minimally invasive and affordable way for many couples to begin their journey to parenthood."
    },
    {
    ...
    },
    {
      ...
      a: "Women with PCOS often have very high success rates at our IVF Centre In Okhla. Once their hormonal cycles are managed by the Best IVF Doctor In Okhla, they often produce a high volume of quality eggs for IVF."
    },
    {
        q: "How long does a typical IVF cycle take?",
        a: "A standard IVF cycle from stimulation to embryo transfer usually takes about 3 to 4 weeks. Most of our Okhla patients find the short morning visits for monitoring to be very convenient and non-disruptive."
    },
    {
    ...
    {
        q: "Can I freeze my eggs in Okhla?",
  ...
  const localSEO = [
    { location: "IVF Centre Near Okhla Phase III", text: "Just minutes away from Okhla Phase III, our clinic offers an elite sanctuary for professionals seeking world-class fertility care." },
    { location: "Fertility Clinic In Kalkaji", text: "Serving the local community of Kalkaji, we provide personalized treatment plans that respect your privacy and medical requirements." },
    { location: "IVF Treatment Near Govindpuri", text: "Located close to Govindpuri, we offer a specialized alternative for advanced reproductive technology and compassionate embryology." },
    ...
    { location: "IVF Specialist Near Sukhdev Vihar", text: "Conveniently accessible from Sukhdev Vihar, our clinic is the first choice for professionals seeking results-oriented fertility treatments like ICSI and Egg Freezing." },
    { location: "Fertility Care In Jasola", text: "Serving the local community of Jasola, we provide compassionate and ethical medical guidance to help you navigate the complexities of infertility with confidence." },
    { location: "IVF Consultation Near Sarita Vihar", text: "Our clinic is a preferred destination for families seeking world-class fertility care near Sarita Vihar with high success rates." },
    { location: "Fertility Clinic In South Delhi", text: "As a leading fertility clinic in South Delhi, we serve as a beacon of hope for thousands. From Okhla to New Friends Colony, we are your partners in building a future." }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Pravi Global IVF Okhla",
            "description": "Best IVF Centre In Okhla offering advanced fertility treatments like IUI, ICSI, and Egg Freezing.",
            "url": "https://praviivf.in/best-ivf-centre-in-okhla-delhi",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="max-w-7xl mx-auto relative z-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 backdrop-blur-md border border-blue-400 rounded-full px-5 py-2 text-blue-100 font-semibold text-sm mb-8">
              ...
              <span>Best IVF Centre In Okhla, New Delhi</span>
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
              Where <span className="text-blue-300 italic">Hope</span> Becomes Reality in Okhla.
            </h1>
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-xl leading-relaxed font-light">
              Experience the perfect harmony of advanced reproductive science and compassionate care. At our Okhla clinic, we don't just treat infertility; we build families.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
              {[
                "Best IVF Clinic In Okhla",
                "High IVF Success Rate Delhi",
                "Affordable IVF Treatment Delhi",
                "Expert IVF Specialist In Okhla"
              ].map((item, i) => (
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight italic">Elite IVF Treatment In Okhla: <br/><span className="text-blue-700">The Sanctuary of Hope.</span></h2>
            <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
              <p>
                When you search for the <strong>Best IVF Centre In Okhla, New Delhi</strong>, you aren't just looking for a clinic. You're looking for a partner who understands the high expectations of our local community.
              </p>
              <p>
                At our Okhla facility, we’ve created a space that feels less like a clinic and more like a sanctuary. We’ve helped thousands of couples from <strong>Kalkaji, Jasola, and New Friends Colony</strong> find their way back to hope through personalized, results-oriented care.
              </p>
              <p>
                  Led by an <strong>IVF Specialist In Okhla</strong> with over 18 years of clinical experience, we pride ourselves on transparency, medical ethics, and achieving success even in the most complex reproductive cases.
              </p>
            </div>
          ...
          <div className="bg-stone-100 rounded-[3rem] p-12 relative overflow-hidden group border border-stone-200">
             ...
             <h3 className="text-2xl font-bold text-blue-900 mb-8">Why Okhla Trusts Us</h3>
             <ul className="space-y-6">
               {[
                 "Consultations with the Best IVF Doctor In Okhla.",
      ...
      <section className="py-24 bg-stone-900 text-stone-100 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 italic">Advanced IVF Treatment In Okhla</h2>
      ...
      <section className="py-24 px-4 bg-stone-50 border-y border-stone-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div>
              ...
              <div className="space-y-6 text-lg text-stone-600 leading-relaxed font-light">
                 <p>
                    Success isn't just about a positive pregnancy test; it's about the healthy delivery of your child. At our clinic in Okhla, we pride ourselves on being honest about your chances while working tirelessly to improve them.
                 </p>
                 <p>
                    We’ve helped thousands of couples from <strong>Kalkaji, New Friends Colony, and Sarita Vihar</strong> find their path to parenthood when they thought all hope was lost.
                 </p>
           ...
           <div className="grid gap-6">
              {[
                { name: "Meera & Rajesh", loc: "Okhla Phase I", text: "We spent years trying on our own. When we finally came here, we felt heard. The Best IVF Doctor In Okhla took the time to explain everything. Now we have our beautiful twin boys." },
                { name: "Anil", loc: "Okhla Phase III", text: "The honesty and scientific precision here are truly world-class. If you are looking for an IVF clinic near Kalkaji or New Friends Colony, this is the place to be." }
              ].map((story, i) => (
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a href="tel:+919999999999" className="bg-blue-950/40 hover:bg-blue-950/60 text-white px-12 py-5 rounded-full font-bold text-lg transition-all flex items-center justify-center gap-3 border border-blue-800 active:scale-95 shadow-xl">
              <Phone className="w-5 h-5"/> Contact Okhla Clinic
            </a>
          </div>
        </div>
      </section>
