    ...
    <section className="relative h-screen overflow-hidden">
      ...
      {slides.map((slide, idx) => (
        ...
        >
          {/* Background Image */}
          <div 
            className="absolute inset-0 bg-cover bg-[78%_top] md:bg-[length:135%_100%] bg-no-repeat -z-20"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="max-w-3xl">
                ...
                <div className="flex flex-wrap gap-4 hidden md:block">
                  ...
                  <Link href="https://api.whatsapp.com/send/?phone=8009150040&text=Hello%21+I+would+like+to+know+more+about+your+services.&type=phone_number&app_absent=0" className="btn-secondary text-lg px-8 py-4 hover:scale-105 shadow-xl bg-white text-teal-900 border-none">
